...
const AboutRevault = () => {
  ...
  return (
    <div
      className={`flex flex-col w-auto ${theme === "light" ? "bg-secondary border-white-50" : "bg-midnight"} p-6 pb-10 rounded-xl border-1 border-white-5`}
    >
      ...
      <div className="text-center">
        <p className="text-lg">
          Revault is a platform for PLM CISTM Students to browse archived
        ...
        <p>
          ...
          <span
            ...
            className="font-bold cursor-pointer hover:text-gold transition-all duration-300"
          >
            Keyboard Warriors
          </span>
        </p>
