  ...
  return (
    <main className="flex flex-col md:flex-row">
      ...
      <div className="flex-1 p-8 flex flex-col gap-5">
        ...
        {hasFilters && (
          <div className="flex flex-wrap gap-2 p-3  rounded-lg border-2 border-white-50 ">
            ...
            <button
              ...
              className="px-2 py-1 bg-red-100 hover:bg-red-200 dark:bg-red-900/20 dark:hover:bg-red-900/40 text-red-800 rounded text-xs cursor-pointer"
            >
              Clear all
            </button>
          </div>
