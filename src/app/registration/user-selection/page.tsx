  ...
  return (
    <div className="flex flex-col justify-center items-center mt-25">
      ...
      <div className="flex flex-row justify-evenly gap-8 mt-10">
        <button className="w-xs h-48 bg-midnight border-2 rounded-lg text-white flex flex-col justify-center items-center p-6 cursor-pointer">
          <PiStudentBold className="size-12 mb-2" />

          {/* Main heading */}
          <p className="text-xl text-center leading-tight mb-1">
            I&apos;m a student
          </p>
