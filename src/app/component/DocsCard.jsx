...
const DocsCard = (props) => {
  return (
    <div className="w-9xl flex align-middle items-center gap-2 p-6 px-8 rounded-xl border border-dusk">
      <div className="w-52">
        <a href={props.link}>
          ...
          <Popover align>
            ...
            <PopoverContent align="end">
              ...
              <div className="flex gap-2 pt-4">
                <button className="cursor-pointer rounded-md bg-dusk py-2 px-4 w-full">
                  Cancel
                </button>
