const WarningMessage = ({
  ...
  return (
    <div
      className={`flex items-center gap-4 h-12 mt-2 bg-yale-blue/10 p-4 rounded-md ${containerClassName}`}
    >
      {/* Icon Container */}
      ...
      <p className={`text-yale-blue text-sm leading-tight w-full ${textClassName}`}>
        {message}
      </p>
    </div>
  );
