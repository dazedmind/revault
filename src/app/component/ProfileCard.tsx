  ...
  return (
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between items-center gap-4 dark:bg-card-foreground p-6 md:p-10 md:px-48">
        ...
        <div>
          <Link
            href={` ${position === "Librarian-in-Charge" || position === "Chief Librarian" || position === "Chief's Librarian" ? `/admin/settings/general/edit-profile` : `/settings/general/edit-profile`} `}
          >
